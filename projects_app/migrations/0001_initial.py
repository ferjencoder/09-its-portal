# Generated by Django 5.0.6 on 2024-07-09 02:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('uploaded', 'Uploaded')], default='pending', max_length=10)),
                ...
                ('deliverable', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='projects_app.deliverable')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deliverables', to='projects_app.project'),
        ),
        migrations.CreateModel(
